...
public class ClassUtils {
	...
	static {
		PRIMITIVE_CLASSES = (new Class[] { Boolean.TYPE, Byte.TYPE, Character.TYPE, Short.TYPE, Integer.TYPE, Long.TYPE,
	...
	public static Constructor getConstructor(Class clz, Class expectedTypes[]) {
		...
		try {
			...
			String msg = (new StringBuilder()).append("Class: ").append(clz.getName()).append(", ")
					.append(clz.getProtectionDomain().getCodeSource().getLocation()).append(", ")
					.append(clz.getClassLoader()).toString();
	...
	public static Class loadClass(final String name) throws ClassNotFoundException {
		...
		Object obj = AccessController.doPrivileged(new PrivilegedAction() {
			...
			@Override
			public Object run() {
				ClassLoader threadCL = ClassUtils.getContextClassLoader();
				if (threadCL != null)
					try {
